  ...
  return (
    <View style={styles.correctionCard}>
      ...
      <View style={styles.correctionBody}>
        ...
        {hint ? <Text style={styles.correctionHint}>{hint}</Text> : null}
      </View>
    </View>
  );
}
    ...
    <View style={styles.levelPills}>
      {CEFR_ORDER.map((code, i) => {
        ...
        return (
          <View
            key={code}
            style={[styles.levelPill, filled && styles.levelPillFilled]}
          />
        );
      })}
    </View>
      ...
      >
        ...
        <View style={styles.card}>
          <View style={styles.levelRow}>
            ...
            <Text style={styles.levelName}>{cefrLabel(cefrCode)}</Text>
          </View>
        ...
        {corrections.length > 0 ? (
          <>
            <Text style={styles.sectionEyebrow}>KEY CORRECTIONS</Text>
